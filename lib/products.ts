...
export const products: Product[] = [
  ...
  },
  {
    ...
    weekly: true,
    bullets: [
      { icon: "🇺🇸", text: "America First. Not Israel First. Zero subtlety." },
      { icon: "😈", text: "Loud, direct, and unapologetic — exactly how it should be." },
      { icon: "👕", text: "Premium Bella + Canvas 3001 — Stupid soft and comfortable" },
      { icon: "⚫", text: "Asphalt color — Dark gray with a cool undertone" },
      { icon: "📏", text: "Unisex fit — True to size. Size up for oversized streetwear look" },
      { icon: "🔥", text: "High-quality DTG print — Won't crack, peel, or fade" },
    ...
    metaDescription: "America First. Not Israel First. Zero subtlety. Maximum chaos.",
    catalogVariantIds: { S: 4031, M: 4032, L: 4033, XL: 4034, "2XL": 4035 },
    printfulVariants: {
      S: 5343998044,
      M: 5343998045,
