...
export const products: Product[] = [
  {
    ...
    bullets: [
      ...
      { icon: "🐱", text: "Here Kitty Kitty Kitty — Classic degenerate humor" },
      { icon: "👕", text: "Premium Bella + Canvas 3001 — Stupid soft" },
      { icon: "📏", text: "Unisex fit — Size up for oversized look" },
      { icon: "🔥", text: "High-quality DTG print" },
    ],
    sizes: ["S", "M", "L", "XL", "2XL"],
    ...
    printfulVariants: { S: 5334281393, M: 5334281394, L: 5334281395, XL: 5334281396, "2XL": 5334281397 },
  },
  {
    slug: "no-fat-chicks",
    title: "NO FAT CHICKS",
    ...
    bullets: [
      ...
      { icon: "👕", text: "Premium Bella + Canvas 3001" },
      { icon: "📏", text: "Unisex fit — Size up for oversized look" },
      { icon: "🔥", text: "High-quality DTG print" },
    ],
    sizes: ["S", "M", "L", "XL", "2XL"],
    ...
    catalogVariantIds: { S: 6948, M: 6949, L: 6950, XL: 6951, "2XL": 6952 },
    printfulVariants: { S: 5334280273, M: 5334280275, L: 5334280277, XL: 5334280279, "2XL": 5334280281 },
  },
  {
    slug: "good-girl",
    title: "GOOD GIRL",
    ...
    catalogVariantIds: { S: 6948, M: 6949, L: 6950, XL: 6951, "2XL": 6952 },
    printfulVariants: { S: 5332833314, M: 5332833315, L: 5332833316, XL: 5332833317, "2XL": 5332833318 },
  },
  {
    ...
    catalogVariantIds: { S: 6948, M: 6949, L: 6950, XL: 6951, "2XL": 6952 },
    printfulVariants: { S: 5330249069, M: 5330249070, L: 5330249071, XL: 5330249072, "2XL": 5330249073 },
  },
  {
    ...
    catalogVariantIds: { S: 6948, M: 6949, L: 6950, XL: 6951, "2XL": 6952 },
    printfulVariants: { S: 5334281381, M: 5334281382, L: 5334281383, XL: 5334281384, "2XL": 5334281386 },
  },
  {
    ...
    catalogVariantIds: { S: 4111, M: 4112, L: 4113, XL: 4114, "2XL": 4115 },
    printfulVariants: { S: 5334289252, M: 5334289253, L: 5334289254, XL: 5334289255, "2XL": 5334289256 },
  },
  {
    ...
    bullets: [
      { icon: "🎆", text: "Just Here To Bang — Exactly what it says" },
      { icon: "🚀", text: "Pin-up girl on a firework" },
      { icon: "👕", text: "Premium Bella + Canvas 3001" },
      { icon: "📏", text: "Unisex fit — Size up for oversized look" },
      { icon: "🔥", text: "High-quality DTG print" },
    ],
    ...
    metaDescription: "Just Here To Bang. Pin-up girl on a firework.",
    catalogVariantIds: { S: 6948, M: 6949, L: 6950, XL: 6951, "2XL": 6952 },
    printfulVariants: { S: 5338187307, M: 5338187308, L: 5338187309, XL: 5338187310, "2XL": 5338187311 },
  },
    {
    slug: "stop-staring",
    title: "STOP STARING",
    ...
    printfulVariants: { S: 5338212054, M: 5338212055, L: 5338212056, XL: 5338212057, "2XL": 5338212058 },
  },
  {
    slug: "mate",
    title: "MATE",
    ...
    flavor: "CHAOTIC ENERGY",
    bullets: [
      { icon: "🩸", text: "Mate — Henry Nowak did nothing wrong" },
      { icon: "😶", text: "I can't breathe... while they handcuffed him" },
      { icon: "⚖️", text: "Justice for Henry Nowak" },
      { icon: "👕", text: "Athletic Heather — Premium Bella + Canvas 3001" },
      { icon: "📏", text: "Unisex fit — Size up for oversized look" },
      { icon: "🔥", text: "High-quality DTG print" },
    ],
    sizes: ["S", "M", "L", "XL", "2XL"],
    metaTitle: "Mate T-Shirt | Unhinged Threads",
    metaDescription: "Mate — Henry Nowak did nothing wrong.",
    catalogVariantIds: { S: 6948, M: 6949, L: 6950, XL: 6951, "2XL": 6952 },
    printfulVariants: { S: 5348765467, M: 5348765468, L: 5348765469, XL: 5348765471, "2XL": 5348765472 },
  },
  {
    slug: "when-im-horny",
    title: "WHEN IM HORNY",
    ...
    printfulVariants: { S: 5342146267, M: 5342146268, L: 5342146269, XL: 5342146270, "2XL": 5342146271 },
  },
  {
    slug: "america-first",
    ...
    weekly: true,
    bullets: [
      { icon: "🇺🇸", text: "America First. Not Israel First." },
      { icon: "😈", text: "Loud, direct, and unapologetic" },
      { icon: "👕", text: "Premium Bella + Canvas 3001" },
      { icon: "📏", text: "Unisex fit — Size up for oversized look" },
      { icon: "🔥", text: "High-quality DTG print" },
    ],
    sizes: ["S", "M", "L", "XL", "2XL"],
    metaTitle: "America First Not Israel First T-Shirt | Unhinged Threads",
    metaDescription: "America First. Not Israel First. Zero subtlety.",
    catalogVariantIds: { S: 4031, M: 4032, L: 4033, XL: 4034, "2XL": 4035 },
    printfulVariants: { S: 5343998044, M: 5343998045, L: 5343998046, XL: 5343998047, "2XL": 5343998048 },
  },
];